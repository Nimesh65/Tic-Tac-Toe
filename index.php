...
<body>
        ...
        <div class="game">
            ...
            <div class="foot">
                <div class="info">
                    ...
                    <h3 class="change">'s Turn</h3>
                </div>
                <button class="bubbles">
                    <span class="text default">Reset Game</span>
                    <span class="text hover">Sure?</span>
                </button>
                <button class="Btn">
    ...
    <!-- <script>
  const full_name = <?php echo json_encode($_SESSION['full_name'] ?? 'Guest'); ?>;
</script> -->
    <script>
        const firstName = <?php echo json_encode($_SESSION['first_name'] ?? 'Guest'); ?>;
